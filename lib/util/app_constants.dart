...
class AppConstants {
  ...
  static const String baseUrl = 'http://192.168.92.174:8000/api';
  static const String imageUrl = 'http://192.168.92.174:8000/';
  ...
  // Helper method to get dynamic base URL
  static Future<String> getDynamicBaseUrl() async {
    return await ApiConfigService.getBaseUrl();
  }

  // Helper method to get dynamic image URL
  static Future<String> getDynamicImageUrl() async {
    return await ApiConfigService.getImageUrl();
  }
